...
{
    public partial class Form1Ban : Form
    {
        ...
        public Form1Ban(string tenDangNhap)
        {
            tenDangNhapNhanVien = tenDangNhap;

            InitializeComponent();

            btnBan.BackColor = Color.FromArgb(4, 170, 109);
            OpenChildForm(new Form2Ban(tenDangNhapNhanVien));
        }
        ...
        private void btnChucNang_Click(object sender, EventArgs e)
        {
            ...
            switch (btn.Name)
            {
                case "btnBan":
                    ...
                    break;
                case "btnLoaiBan":
                    OpenChildForm(new Form2LoaiBan(tenDangNhapNhanVien));
                    break;
                case "btnKhuVuc":
                    OpenChildForm(new Form2KhuVuc(tenDangNhapNhanVien));
                    break;
            }
        }
    }
